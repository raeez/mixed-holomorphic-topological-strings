...
single class \textemdash{} ordinary \(\lie{gl}_N\) is obstructed by
...
\begin{rmk}[Reading via the obstruction--twist schema]\label{rmk:scalar-anomaly-route-Gschema}
...
\label{thm:app-theta-three-finite-window-H1}
  ...
  three repair data \textemdash{} the supplied scalar-zero counterterm
  ...
  \textemdash{} each returning
  \(\texttt{primitive\_exists}=\mathrm{true}\) with the corresponding
  unit primitive coefficient.
\end{thm}

\begin{rmk}[Reading via the obstruction--twist schema]\label{rmk:theta3-route-Gschema}
  The \(\theta_3\) finite-window dichotomy is the prototype of clause~(2)
...
\label{rmk:app-theta-three-dichotomy-sub-theorem}
  ...
  of the three repair data \textemdash{} CE ancestor with controlled boundary,
...
\begin{rmk}[Reading via the obstruction--twist schema]\label{rmk:cotangent-lift-route-Gschema}
  Under Theorem~\ref{thm:obstruction-twist-dichotomy} of
...
\label{rmk:app-cotangent-lift-first-nontrivial-occurrence}
  ...
  counterterm-absent sub-theorem; case (b) of the same theorem gives
