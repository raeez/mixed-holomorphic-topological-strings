...
The scalar part of the mixed brane-defect QME, the algebraic current
presentation after passage to distributional principal-part currents,
and the cancellations before scalar reduction or after balanced
superization are formal-local.  Every
...
\]
The calculation separates five formal-local facts: finite
