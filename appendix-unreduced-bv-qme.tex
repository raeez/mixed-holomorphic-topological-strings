...
Fix the formal-local mixed habitat
...
\label{thm:app-constructive-nonscalar-costello-qme-realization}
  ...
  \]
  in the completed native brane-defect kernel complex.  A larger
...
\label{def:app-normal-omega-costello-kernel-datum}
  ...
  \end{enumerate}
  This datum supplies the equivariant habitat: coefficient ring,
