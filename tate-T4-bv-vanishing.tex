...
\begin{stmt}[Costello--Li 2012 BCOV construction,
  ...
  primary-source precedent here are used only under their stated
  hypotheses.
\end{stmt}
...
\begin{rmk}[Costello--Li convention boundary]\label{rmk:t4-external-comparison-boundary}
  ...
  coefficient normalization.  Costello--Li 2012 supplies the convention
  template used to state the coefficient problem for the unreduced
  cotangent lift.
\end{rmk}
