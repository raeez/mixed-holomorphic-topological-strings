...
\label{cor:app-full-defect-polarization-slogan}
  ...
  cotangent module itself.  The Dirac brane formal-stalk chart measures
  positions polynomially through \(\bar A\), and its cotangent momenta
  live as residues through \(\mc P\); the shared bidegree label is
