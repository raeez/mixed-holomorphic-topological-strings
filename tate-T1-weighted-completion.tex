...
Theorem~\ref{thm:strict-unweighted-obstruction} sharpens this to the
...
\begin{defn}[Equivariant finite normal window]\label{defn:wt-omega-normal-window}
  ...
  \((N,M)\).  An analytic Kothe norm in place of the algebraic
  ...
  \]
  for every inverted character.  This quantitative bound upgrades the
...
\label{defn:wt-nonscalar-qme-tower}
  ...
  differential are the transported finite-window structures supplied by
	  the weighted RG criterion; naive projected Hamiltonian brackets are
...
\label{defn:wt-regular-density-closed-exchange-complex}
  ...
  \]
  This is a finite-window graph complex.  The naive finite-dimensional
...
\begin{proof}
  ...
  This criterion supplies the invariant operation beyond quotienting by
...
\begin{proof}
  ...
  is proved as a distributional graph layer.  When some
