...
factor lies in \(\prod_dH_d^\vee\), not in \(\bigoplus_dH_d^\vee\).  The
diagnosis below isolates that obstruction; the weighted Mittag--Leffler
completion of the next subsection cures it by replacing the direct-sum
