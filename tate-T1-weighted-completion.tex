...
Mittag--Leffler, heat-kernel, and classical cochain statements.
...
solution is exactly the weighted RG criterion
\ref{stmt:weighted-rg-criterion}.  For \(q,q'>1\), admissible
...
endpoint exists precisely under
Definition~\ref{defn:endpoint-admissible-coefficient-module}.  The
strict product/direct-sum Tate pair carries the endpoint obstruction
