...
polydisk; its observables are the stable scalar-reduced traces
\(J(f)=\overline{\operatorname{Tr}f(\phi_1,\phi_2)}\), which exhaust
the gauge-invariant content of the probe pair.}
...
\(\Psi_{a,b}\) carry the same labels but a strictly different
...
original target.  The obstruction calculus is simultaneously the
