...
are the higher brackets of the minimal model: vanishing gives strict
coherence; null-homotopy gives counterterm coherence; central
...
\(\mathcal T\rightsquigarrow\mathcal T'\).}
...
Q+\hbar\Delta_L+\{S_\infty,-\}\bigr)\) in local-functional
cohomology, with \(\theta_3\) finite-window prototype:
