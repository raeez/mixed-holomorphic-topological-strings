...
\begin{proof}
  ...
  weighted-Tate target.  The
	  third item separates two inputs: Lemma~\ref{lem:continuous-bar-cobar}
	  supplies the closed Lie bar-cobar/enveloping comparison when its
	  lower-central Tate-pronilpotence hypothesis holds, while the additional
	  open \(A_\infty\)-Koszul comparison requires a separate open-side
	  acceptance datum.  The obstruction
