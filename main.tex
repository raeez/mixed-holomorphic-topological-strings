...
\paragraph{Convention scope and cross-target transport.}  Transport of the local theorem
...
The full cross-target scope theorem
...
cross-target scope theorem (Theorem~\ref{thm:cross-target-firewall}),
none of the
...
construction; the cross-target scope theorem
(Theorem~\ref{thm:cross-target-firewall})
