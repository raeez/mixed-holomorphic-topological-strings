...
\end{titlingpage}
  ...
  \medskip\noindent
  Uniqueness of $J$.  Procesi--Razmyslov \cite{procesi}\cite{razmyslov}
  ...
  Loday--Quillen--Tsygan \cite{loday-quillen}\cite{tsygan} identify the
...
\label{exa:two-branes-generic}
  ...
  \cite{procesi}\cite{razmyslov}; the dictionary
...
Procesi--Razmyslov 1976/1980 \cite{procesi}\cite{razmyslov} identify the
...
\begin{proof}
  Procesi--Razmyslov~\cite{procesi}\cite{razmyslov} identifies
...
\cite{procesi}\cite{razmyslov}: stable invariants of two matrices are freely
...
\cite{loday-quillen}\cite{tsygan}\cite{loday-vallette} supplies the primitive
...
1976 (\cite{procesi}\cite{razmyslov};
...
\begin{proof}
  Procesi--Razmyslov invariant theory \cite{procesi}\cite{razmyslov} gives two
...
\begin{proof}
  ...
  through Procesi--Razmyslov stable invariants \cite{procesi}\cite{razmyslov}
  (Proposition~\ref{prop:stable-trace-invariants}) and
  Loday--Quillen--Tsygan primitivity \cite{loday-quillen}\cite{tsygan}.
...
\begin{proof}
  ...
  invariant theory \cite{procesi}\cite{razmyslov}
...
\begin{rmk}
  ...
  \cite{costello-li-quantum-bcov}\cite{costello-li-open-closed-bcov} apply
...
\begin{stmt}[Costello perturbative BV construction]\label{stmt:costello-bv-construction}
  ...
  \cite{costello-gwilliam}\cite{costello-gwilliam-vol2}.
\end{stmt}
...
\begin{proof}
  ...
  Razmyslov--Procesi description \cite{razmyslov}\cite{procesi} of the full
...
\begin{proof}
  ...
  with classical Capelli identity \cite{capelli}\cite{howe-capelli};
