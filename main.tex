...
\end{titlingpage}
  ...
  de Rham complex.  A Beilinson--Drinfeld curve chiral algebra or
  vertex algebra appears only after restriction along a holomorphic
  $C\hookrightarrow\C^2$ (Remark~\ref{rmk:not-a-curve-voa}).
