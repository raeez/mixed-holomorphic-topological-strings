...
degree-shifted dual partner; continuity of the polydisk topology fixes that
...
Theorem~\ref{thm:app-defect-polarization} forces this polarization
over the polynomial PBW shadow, since the Moyal coadjoint action acts
on the residue side and does not lift to the polynomial substitute).
Both inputs are forced; the closed BV field complex is the unique
local realization of the resulting shifted-cotangent Lie algebra
