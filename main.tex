...
\end{titlingpage}
  ...
  chosen null-homotopies, supplied by the supremum constructions of
...
derived centre of the open category is the Mixed
Holomorphic--Topological Deligne conjecture; this manuscript
proves its formal-Darboux stalk at the brane vacuum.  Throughout, when
\(C^\bullet_{\mathrm{ch}}(A_b,A_b)\) appears at \(d=2\), \(A_b\) carries
the chiral algebra structure inherited as the formal-Darboux stalk
of the closed-string sector classical observables factorization
algebra on \(\C^2\); the local identification at the stalk reduces to
the derived \(E_1\)-centre of the open-string \(E_1\)-brane algebra by
...
formal-Darboux stalk with the chiral derived centre
\(C^\bullet_{\mathrm{ch}}(A_{b_p},A_{b_p})\) at \(d=2\).
...
selects a Lagrangian inside that polydisk; the polydisk supplies the
Hamiltonian deformations as conjugate matrix coordinates on the brane.
...
formal-Darboux stalk with the chiral derived centre
\(C^\bullet_{\mathrm{ch}}(A_{b_p},A_{b_p})\) at \(d=2\)
(\S\ref{ssec:binding-convention-layer}).  Here
...
identifies this at the formal-Darboux stalk with the chiral derived
centre \(C^\bullet_{\mathrm{ch}}(A_{b_p},A_{b_p})\) at \(d=2\).
...
identifies this at the formal-Darboux stalk with the chiral derived
centre \(C^\bullet_{\mathrm{ch}}(A_{b_p},A_{b_p})\) at \(d=2\).  Two
...
target with the chiral derived centre
\(C^\bullet_{\mathrm{ch}}(A_{b_p},A_{b_p})\) at \(d=2\).
...
Holomorphic--Topological Deligne conjecture identifies the resolution
target with the chiral derived centre
\(C^\bullet_{\mathrm{ch}}(A_{b_p},A_{b_p})\) at \(d=2\).  The
...
\(C^\bullet_{\mathrm{ch}}(A_b,A_b)\) at the chart \(A_b=\mathrm{End}(b)\)
of the chosen Dirac brane vacuum \(b\): a global compact-target
...
the chiral derived centre \(C^\bullet_{\mathrm{ch}}(A_{b_p},A_{b_p})\)
at \(d=2\).  Scalar reduction kills the constant
...
\([\Phi_\hbar(z_1),\Phi_\hbar(z_2)]_\star=\hbar N\cdot I\) in $M_N(\C)$ --- three faces
of one class
(Theorem~\ref{thm:app-scalar-anomaly-transgression}).
...
The brane-side computation
\(A^{\mathrm{cl}}_{\partial,N}=
C^\bullet_{\mathrm{CE}}(\mathfrak{gl}_N,\,
\mathrm{Kosz}([\phi_1,\phi_2]))\),
\(J(f)=\overline{\operatorname{Tr}f(\phi_1,\phi_2)}\),
\(c_f\mapsto\theta_f\), \(u_f\mapsto J(f)\) is tested below as a
compatibility check against the well-defined \(d=1\) chiral derived
centres of the central families.  At \(d=1\) the chiral derived
...
\(u_f\mapsto J(f)\).  The Capelli scalar \(\hbar N[\bar c]\)
vanishes identically:
\([\bar c]=0\in H^2_{\mathrm{Lie}}(\bar A,\C)[[\hbar]]\) on the
cyclic-collapsed quotient at \(N=1\), and the order-\(\hbar\)
...
cocycle on the chiral Hochschild bulk module
\(C^\bullet_{\mathrm{ch}}(A_b,A_b)\) at the \(K3\times E\) brane
vacuum, twisted by \(\Omega_{\mathrm{central}}\) at level 2, whose
...
conjecture identifies this at the formal-Darboux stalk with the
chiral derived centre $C^\bullet_{\mathrm{ch}}(A_{b_p},A_{b_p})$ at
$d=2$, generalising the Beilinson--Drinfeld chiral Deligne theorem
proved at $d=1$ for chiral algebras factorising over curves.  The
