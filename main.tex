...
\end{titlingpage}
  ...
  classical observables is the holomorphic factorization algebra on
  \(\C^2\) valued in \(E_2\)-algebras
  \[
  ...
  Corollary~\ref{cor:E2-bulk-algebra}).  The brane is its
  \(E_1\)-module
  ...
  \]
  is Koszul duality between bulk \(E_2\) and brane \(E_1\) in the
  Costello sense, with reduced-coordinate shadow
  \(c_f\mapsto\theta_f\), \(u_f\mapsto O_f=J(f)\)
  (Theorem~\ref{thm:closed-to-open-derived-centre-map}).  The native
  object is a holomorphic factorization algebra on \(\C^2\) valued in
  \(E_2\)-algebras, not a curve vertex algebra
