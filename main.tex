...
\end{titlingpage}
  ...
  polydisk.  A stack of \(N\) Dirac branes on the topological line records
  its position in the normal polydisk through a commuting pair of
  ...
  the formal normal polydisk admits a literal evaluation on the brane's
  ...
  Hamiltonian Lie algebra of the formal symplectic polydisk modulo
  ...
  The all-order algebraic quantization of the formal symplectic polydisk
