...
\end{titlingpage}
  ...
  BV form of Costello and Costello--Li
  ...
  cyclic framed stable branch the universal local probe of
  \(\Hilb^N(\C^2)\) in its noncommutative Moyal deformation.
  ...
  obstruction classes above as the formal-local input.  No such
  globalization is proved here; cross-volume use is routed through
  the matched-conventions theorem
  \ref{thm:matched-conventions-transfer}.
...
content of the probe pair, the full stable \(GL_N\)-invariant ring is
the polynomial algebra on this primitive (Procesi--Razmyslov first
fundamental theorem), and the closed sector
...
construction defect.  The chain-level primitive projection of
