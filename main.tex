...
vector]\label{defn:tate-cotangent-lift-obstruction-vector}
  ...
  \begin{equation}\label{eq:tate-obstruction-vector}
    \operatorname{Ob}_T
      ...
      \bigr),
  \end{equation}
  with the components: the weighted Casimir kernel class
  ...
  matched-conventions class \(\mathfrak o_{\mathrm{cv}}\).  Each habitat
  is fixed in the paragraphs below.  The Costello--Li 2012 BCOV/HCS
  theorem is not a transferable source for the present brane-defect
  geometry; the hypothesis-separation lemma below forces the eight
  components.
\end{defn}
