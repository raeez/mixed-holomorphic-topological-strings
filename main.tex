...
This section defines the formal-Darboux stalk chart and the
Hamiltonian BF data on which the main local theorem
(Theorem~\ref{thm:main-local}) and the global obstruction-vanishing
theorem (Theorem~\ref{thm:main-global-conditional}) rest.
...
\begin{rmk}[Cyclic framing branch and the Hilbert scheme]\label{rmk:cyclic-framing-hilbert-branch}
  ...
  \(U(1)\) charge.  The framing data selects a stable open substack of
  the Dirac brane stack on which the derived fibre is underived.
\end{rmk}
...
\begin{rmk}[Obstruction to the strict-product CE/PV comparison]
  ...
  \(H_2\cong\mathfrak{sl}_2\) lower-central obstruction to conilpotence;
  Remarks~\ref{rmk:colim-obstruction-full-h} and
...
identification on $\partial X^{\mathrm{KN}}$
...
\operatorname{Ob}^{\mathrm{desc}}_{\mathrm{KN}}\oplus
...
\begin{proof}
  ...
  Remark~\ref{rmk:colim-obstruction-full-h},
...
\begin{proof}
  ...
  coordinate windows (Theorem~\ref{thm:wt-cotangent-lift}) and the
...
\begin{rmk}[Consistency probes]\label{rmk:consistency-probes}
  ...
  \begin{enumerate}[label=\textup{(\arabic*)}]
    ...
    \item \emph{Global descent first obstruction.}
      $[d_2]\in H^2\bigl(\partial X^{\mathrm{KN}},
...
\begin{proof}
  ...
  $\operatorname{Ob}^{\mathrm{desc}}_{\mathrm{KN}}$ vanishes on a
...
\begin{thm}[Mixed Holomorphic--Topological Deligne identification on the Kato--Nakayama log boundary]\label{thm:main-global-conditional}
  Let $(X,D,\tau)$ be a holomorphic-symplectic log surface with
  Kato--Nakayama log boundary $\partial X^{\mathrm{KN}}$, with bulk
  mixed-HT factorization algebra
  $\mathcal A^{\mathrm{cl}}_{\mathrm{bulk}}$ of
  Definition~\ref{def:closed-mixed-HT-factorization} and open boundary
  factorisation category $\mathcal C^{\mathrm{op}}_\partial$ of
  Dirac branes on $\partial X^{\mathrm{KN}}$.  The global
  identification
  \[
    \mathcal A^{\mathrm{cl}}_{\mathrm{bulk}}
    \;\simeq\;
  ...
  \]
  as mixed-HT chiral algebras on $\partial X^{\mathrm{KN}}$ holds if
  and only if the three-component global obstruction
  \[
    \operatorname{Ob}^{\mathrm{global}}
      \;=\;
    \operatorname{Ob}^{\mathrm{ch}\,E_2}_{\mathrm{Deligne}}
      \;\oplus\;
    \operatorname{Ob}^{\mathrm{desc}}_{\mathrm{KN}}
      \;\oplus\;
    \operatorname{Ob}^{\mathrm{QME}}_{\mathrm{all\mbox{-}loop}}
  \]
  vanishes, where:
  \begin{itemize}
    ...
    \item
      ...
      is the $d_2$-differential of the descent spectral sequence on
      the Kato--Nakayama log-étale cover trivialising the local
      holomorphic-symplectic Darboux data, with $\mathcal H^\bullet$
      the local-stalk sheaf assigned by
...
\begin{rmk}[Local trivialisation of the global obstruction]
  ...
  these locally trivialised classes along
  $\partial X^{\mathrm{KN}}$.
\end{rmk}
...
\paragraph{Matched-conventions component \(\mathfrak o_{\mathrm{cv}}\).}
...
\begin{figure}[H]
  ...
  \end{tikzpicture}
  \caption{Notation diagram for the reduced open-line order-\(\hbar\) raw
...
\begin{lem}[Tate Casimir obstruction for the full Hamiltonian sector]\label{lem:tate-casimir-obstruction}
  ...
  the full Hamiltonian sector has a BV pairing; a Costello coefficient
  kernel in this topology requires a different coefficient category. The
...
supplying $\operatorname{Ob}^{\mathrm{desc}}_{\mathrm{KN}}\oplus
