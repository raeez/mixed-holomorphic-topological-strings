...
A parallel firewall sits on the principal-part current sector.
Theorem~\ref{thm:bmk-finite-window-obstruction} below proves, by the single
...
\begin{cor}[Pro-Matlis retract as the selected supremum form]\label{cor:promatlis-retract-as-supremum}
  ...
  \[
    ...
    \quad(M\geq N).
  \]
  The pro-Matlis retract is therefore the
  terminal object of \(\mathsf{Curr}^{BM}\), the supremum form of the
  BMK lane.  The obstruction theorem~\ref{thm:bmk-finite-window-obstruction} is
  the structural selector that proves the necessity of the pro-Matlis
  category in place of every finite-Matlis target.
\end{cor}
