...
The weighted Tate field complex \eqref{eq:wt-field-complex} carries an
infinite tower of coefficient bundles indexed by Hamiltonian degree.
Costello's heat-kernel BV calculus
\cite{costello-renormalization}*{Chs.~5--7} requires a free elliptic
complex with finite-rank coefficient bundle, and its Hadamard
parametrix expansion together with Hörmander's wave-front-set tracking
controls singular support along the diagonal.  The forcing question:
does this finite-rank machinery survive the strict Mittag-Leffler
inverse limit in the coefficient direction?  The answer is recorded
here: it does, exactly because the weighted propagator factors as a
spacetime-Hadamard tensor coefficient-Casimir, and the coefficient
factor carries no spacetime singular support.
