...
\begin{cor}[Pro-Matlis retract as the supremum form selected by the
  ...
  transfer.  The unique surviving target compatible with both the BMK
  homotopy data and the full Hamiltonian coadjoint action is the
  ...
  supremum form of the BMK lane.  The no-go
  Theorem~\ref{thm:bmk-finite-window-no-go} is the structural selector
  which proves the necessity of the pro-Matlis category in place of
...
\begin{rmk}[Reading via the obstruction--twist schema]\label{rmk:bm-route-Gschema}
  ...
  finite Matlis target \(P_{\le N}\) is non-absorptive \textemdash{} neither
  exact nor central in any admissible extension of the target \textemdash{}
