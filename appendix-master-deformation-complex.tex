...
branch obstructs internal counterterms, and the admissible repair is the central extension
...
central: every admissible extension of
...
window is a measurement truncation rather than a closed dynamical
subsystem.
\end{description}
...
windows (Theorem~\ref{thm:bmk-finite-window-obstruction}; genuine-obstruction
