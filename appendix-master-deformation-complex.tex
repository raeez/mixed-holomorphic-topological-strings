...
The trace substitution \(J\) determines a single Maurer--Cartan datum
\(\Theta_{\mathrm{loc}}\) whose image under quantization,
globalization, factorization-centre lift, modular clutching, and
CY-categorical specialisation produces the obstruction classes
