\section{The obstruction calculus: master deformation complex of local-to-global coherence}\label{sec:obstruction-calculus}\label{app:master-deformation-complex}

The four-curvature taxonomy classifies the global obstructions to
the formal-Darboux stalk identification of
Theorem~\ref{thm:main-local}: the single curvature
\(F_{\mathcal T}(\Theta_{\mathrm{loc}})\in
H^2(\mathfrak K_{\mathcal T},\Theta_{\mathrm{loc}})\) of the master
deformation complex \(\mathfrak K_{\mathcal T}\) lies on exactly one
of four cells --- strict, counterterm-coherent, projective, or
target-replacement --- and the six manuscript obstruction classes
...
\(\operatorname{per}_X(v)\) are six gauge-slice coordinates of this
single curvature.  The convention layer of
\S\ref{ssec:binding-convention-layer} fixes the symbols:
\(d=\dim_\C X\),
...
below is a coordinate of the curvature decomposition recorded
under that convention layer.
...
\subsection{Four-curvature taxonomy and six-coordinate classification}\label{ssec:master-deformation-dichotomy}

\begin{thm}[Four-curvature taxonomy of the formal-Darboux stalk identification]\label{thm:four-curvature-taxonomy}\label{thm:obstruction-twist-dichotomy}
