...
\begin{stmt}[Statement: native \(\C^2\) holomorphic factorization taxonomy]\label{thm:lane-local-chiral-taxonomy}
...
\begin{stmt}[Statement: native \(\C^2\) holomorphic factorization algebra and vertex boundary]\label{thm:lane-holomorphic-defect-voa-restriction}
  \emph{Status.} \emph{proved native \(\C^2\) holomorphic factorization construction,
  with a precise residual boundary for one-dimensional vertex/OPE
  specialization}.  The manuscript has constructed a native \(\C^2\)
  Hamiltonian holomorphic factorization algebra.  The valid obstruction is
  ...
  \emph{Local assertion.} The native \(\C^2\) holomorphic factorization
  object is
  \[
  ...
  \[
    ...
    \Omega^{0,\bullet}_c(B)\widehat\otimes\mathfrak g .
  \]
  The brane avatars of this native \(\C^2\) holomorphic factorization object are the
  ...
  Theorem~\ref{thm:componentwise-quantum-coefficient-comparison} give the Weyl/Moyal
  ...
  further specialization of the native \(\C^2\) holomorphic factorization
  ...
  the supplied vertex data; it is not needed for the native \(\C^2\)
  holomorphic factorization algebra.  In the \(\C\times\R\) interface below,
...
\begin{defn}[Admissible open-trace \(A_\infty\)-Koszul acceptance datum]\label{defn:stable-ainfty-koszul-acceptance-datum}
  An admissible open-trace \(A_\infty\)-Koszul acceptance datum consists of:
...
\begin{stmt}[Statement: reduced principal-part defect currents]\label{thm:lane-reduced-principal-part-current}
  ...
  setting.  Remark~\ref{rmk:reduced-principal-part-currents} and
  Remark~\ref{rmk:unreduced-lift-obstruction} state the unreduced
  obligations.  Theorem~\ref{thm:chain-level-primitive-projection},
  Corollary~\ref{cor:unreduced-d-closed}, and
  Remark~\ref{rmk:T5-primitive-shadow-scope} supply only the primitive
...
\begin{stmt}[Statement: degree-zero Moyal/Weyl sector and graph boundary]\label{thm:lane-moyal-degree-zero}
  ...
  Proposition~\ref{prop:app-free-residual-vanishings} supplies the
  ...
  Theorem~\ref{thm:componentwise-quantum-coefficient-comparison}; the non-scalar
...
\begin{stmt}[Statement: local graph/QME branch catalogue]\label{thm:lane-local-graph-qme-branch-catalogue}
  ...
  \begin{enumerate}[label=(\arabic*)]
    ...
    theorem for that source envelope, not a global no-go for larger
  ...
  Proposition~\ref{prop:app-first-order-three-enlarged-row}.  The
  regular-density and wavefront branches are
  Proposition~\ref{prop:wt-regular-density-curvature-criterion},
