...
(Theorem~\ref{thm:formal-local-universal-property}).  A candidate
datum lies in \(\mathsf{ProtHam}\) iff the four-coordinate class
\[
...
coordinate names the exact ambient mechanism that fails.

External acceptance of an admissible datum into a compact-CY, MNOP,
GV, OSV, DT, PT, Vol III, Igusa, or BKM target is a separate
