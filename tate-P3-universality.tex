...
universality without a vanishing certificate or a named nonzero
...
isomorphism, and when one fails to vanish the precise coordinate
records what the ambient datum has that the formal local model has
not yet absorbed.
...
its own named obstruction vector.  Together these three closures
...
\begin{lem}[Primary obstruction test]\label{lem:protected-primary-obstruction-test}
  ...
  Definition~\ref{defn:admissible-protected-hamiltonian-restriction}
  if and only if the four named classes of
...
\begin{proof}
  ...
  Definition~\ref{defn:admissible-protected-hamiltonian-restriction}.
  The four named vanishings therefore supply the four admissibility
  clauses, and conversely each admissibility clause records the
  vanishing of its named class.
\end{proof}
