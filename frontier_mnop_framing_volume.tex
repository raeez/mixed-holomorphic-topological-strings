...
\begin{proof}
  ...
  (strict semistables are absent); the moduli $M$ is then a smooth projective
  ...
  Under failure of $(\star)$, $\mathcal{U}$ exists as a
...
arithmetic genus rather than the number \(n_\beta^0\) of rational
curves, so finite-genus and finite-degree data alone leave the
