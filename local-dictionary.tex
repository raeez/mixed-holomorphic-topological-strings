...
\hline
Native two-dimensional holomorphic OPE &
...
\]
For \(x,y\in\mathfrak g\) the native current OPE is
\[
...
two-complex-dimensional OPE; it is not a one-variable Laurent VOA
expansion.\\
\hline
...
starts from the native diagonal OPE above and requires the extra datum
\[
  \mathfrak R_L
  =
...
algebra.  The two-complex-dimensional singular coefficient before
restriction is \(H^2_\Delta(\C[[z,w]])\,d\zeta_1d\zeta_2\), not
\(\C((w))/\C[[w]]\,dw\).\\
\hline
...
\(\hbar_\omega=\hbar_{\mathrm{W}}\).  Without this line or parameter, the refined
