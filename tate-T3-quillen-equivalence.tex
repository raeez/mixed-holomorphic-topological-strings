...
\(c_f\mapsto\theta_f,\ u_f\mapsto J(f)\) descends to a quasi-isomorphism
on cohomology between the closed CE cochain algebra and the Schouten
polyvector algebra of the boundary Hamiltonian polynomial algebra.  This
is the Beilinson--Drinfeld / Loday--Vallette / Lurie Koszul-resolution
identification of the chiral Hochschild cohomology
\(\mathcal A^{\mathrm{cl}}_{\mathrm{bulk}}|_b\) at the formal-Darboux stalk:
