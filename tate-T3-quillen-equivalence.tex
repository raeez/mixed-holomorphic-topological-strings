...
(Theorem~\ref{thm:universal-filtered-cobar-recognition}).  Inside the
admissible Tate envelope of Statement~\ref{stmt:tate-model-envelope},
the bar-cobar adjunction $\Omega\dashv\mathrm{Bar}$ is a Quillen
equivalence (Theorem~\ref{thm:tate-bar-cobar-quillen}) and descends to
an equivalence of associated $\infty$-categories
