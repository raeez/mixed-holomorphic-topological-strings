...
already $\{z_1^4,z_2^4\}_\hbar\supset 24\hbar^2 z_1z_2\notin
\mathfrak m^3$, so $\mathfrak h_{\leq N}$ is not Moyal-closed for
$N\geq4$.  Theorem~\ref{rmk:colim-does-not-recover-full} shows the
inverse limit of nilpotent windows recovers
$\mathfrak m^3\subsetneq\mathfrak h$, not the whole reduced
Hamiltonian algebra.
