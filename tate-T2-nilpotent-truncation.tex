...
The choice $k=2$ retains the conformal-symplectic $\mathfrak{sl}_2$:
the degree-$2$ piece $H_2=\mathrm{span}\{z_1^2,z_1z_2,z_2^2\}$ is
Poisson-closed, $\{H_2,H_2\}\subset H_{2+2-2}=H_2$, with explicit
