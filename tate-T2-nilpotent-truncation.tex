...
\emph{(iv).}  The cocycle $\omega$ pairs $H_a\otimes H_b$ nontrivially
only when $(a,b)=(1,1)$, by the indicator
$\mathbf 1[(k+m,l+n)=(1,1)]$; both arguments must lie in
$H_1\subset\mathfrak m\setminus\mathfrak m^2$, hence outside
$\mathfrak h_{\leq N}=\mathfrak m^3/\mathfrak m^{N+1}$.  No central
extension class therefore survives the truncation.
