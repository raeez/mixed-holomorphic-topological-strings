\section*{Nilpotent truncation of the cotangent module}

The CE/PV Koszul resolution of the chiral Hochschild cohomology
\(C^\bullet_{\mathrm{ch}}(A_b,A_b)\) is constructed unconditionally on
...
Koszul resolution of \(C^\bullet_{\mathrm{ch}}(A_b,A_b)\) on the cubic
...
\(C^\bullet_{\mathrm{ch}}(A_b,A_b)\) on the cubic truncation: a
...
\(C^\bullet_{\mathrm{ch}}(A_b,A_b)\) on the cubic ideal
