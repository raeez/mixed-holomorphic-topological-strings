...
\(\mathfrak h=\mathfrak m=(z_1,z_2)\C[[z_1,z_2]]\).  This subsection
studies a different construction: the lower-central pronilpotent
finite-window route.  That route starts with the cubic Lie subalgebra
...
\subsubsection{The classical truncated cotangent CE/PV identification}
...
$\mathfrak h_{\leq N}$: the locality bracket
...
\subsubsection{Quantum obstruction for the finite truncation}
...
\begin{proof}
  ...
  restriction of the Moyal bracket.  A projected bracket carries its own
  Jacobi class; the projected-degree warning of
...
\subsubsection{Cubic inverse-limit survivor}
...
\subsubsection{Costello--Li precedent}
