...
The cubic nilpotent truncation gives a finite classical CE/PV
calculation on
\(\mathfrak h_{\leq N}=\mathfrak m^3/\mathfrak m^{N+1}\).  The full
unreduced Tate-coefficient cotangent lift is governed by
\ref{prob:formal-factorization-center}.  Its deciding obstructions are
...
(no finite-dimensional Lie truncation of the full sector).  Weighted
Tate completion changes the coefficient category.  Nilpotent truncation
closes the classical finite CE/PV shadow and leaves the quantum
