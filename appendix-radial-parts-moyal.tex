...
\label{rmk:app-radial-bicomplex-mechanism}
  ...
  isolates the structural mechanism uniformly behind every closed
  bidegree.  At contraction degree~\(0\), the residual is the
  cyclic shear sum minus the Weyl average; the necklace Stokes
