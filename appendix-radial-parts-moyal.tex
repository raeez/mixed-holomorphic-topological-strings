...
\label{rmk:app-radial-finite-verification}
  ...
  arithmetic; computational cost in \(\texttt{--kernel-correction}\)
  mode grows roughly as the cube of \(\binom{a+b-2}{a-1}\), so
  bidegrees of total degree \(\geq 16\) require longer runs but the
  underlying linear algebra is unconditional.  The structural
