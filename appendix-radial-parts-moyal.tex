...
bidegree\textemdash{}basis ordering \(\beta_{a,b}\), matrix entries of
...
\(C^+_{a,b}\) when one exists\textemdash{}are read off the elimination
implemented in
\texttt{scripts/quantum\_shear\_trace\_diagram\_normal\_form.py}.
...
\begin{rmk}[Range of bidegrees treated]\label{rmk:app-radial-quantum-shear-script-verified-range}
  ...
  \((6,8),(8,6),(7,7)\).  The all-bidegree statement
