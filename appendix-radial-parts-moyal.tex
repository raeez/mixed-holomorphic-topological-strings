...
at each bidegree \((a,b)\) by a single class
\[
...
\(\hbar N\) term; the residual class \(R^{\mathrm{free}}_{a,b}\)
lies entirely in this positive part.  Its vanishing is proved by
testing on the Cartan
...
>>>>>>> cb1cb91 (reconstitute(local-model-B): measurement-test framing, scalar-anomaly leadoff, obstruction template, kernel-correction window extension)
  \]
