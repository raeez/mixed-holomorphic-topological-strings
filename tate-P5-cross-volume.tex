...
\begin{proof}
  ...
  Lemma~\ref{lem:no-formal-disk-transfer}.  The matched-conventions
  acceptance is the content of
  Theorem~\ref{thm:matched-conventions-transfer}.  Per-target
  divergence and coordinate independence are the seven divergence
  theorems Theorem~\ref{thm:divergence-bcov},
...
(conditional on a chosen null-homotopy).  No row is implied by
another; coordinate vanishing is independent across rows.
