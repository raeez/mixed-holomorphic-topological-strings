...
specialisation is the d=1 Beilinson--Drinfeld theorem
...
coordinate is a named obstruction, not a scalar mismatch.
...
external programme through \(\operatorname{Ob}_{\mathrm{UKD}}\), not
asserted by the local theorem.
...
\begin{thm}[Conditional matched-conventions transfer criterion]\label{thm:matched-conventions-transfer}
  ...
  omitted when the corresponding BCOV, Vol III, Igusa/BKM, GW/DT/PT/MNOP,
  OSV, six-relation, or mixed-Dunn structure is not part of
  ...
  Maurer--Cartan obstruction tower, and the absence of
