...
\begin{proof}
  ...
  consequences of the formal disk.  Therefore a nonzero component is
...
\begin{thm}[Vol III CY-to-chiral divergence and matched-conventions]\label{thm:divergence-volIII}
  ...
  \begin{enumerate}[label=(\roman*)]
    \item \emph{Divergence.}  The Vol III convention is the two-stage
      ...
      \(\R^2_{\mathrm{top}}\times\widehat{\C^2}_{0,\mathrm{hol}}\),
      whose holomorphic factor is a formal disk and whose Calabi-Yau
...
\begin{thm}[GW / DT / PT / MNOP divergence and matched-conventions]\label{thm:divergence-gwdt}
  ...
  \begin{enumerate}[label=(\roman*)]
    \item \emph{Divergence.}  The GW/DT/PT/MNOP convention layer
      ...
      local theorem, whose holomorphic factor is the formal disk
...
\begin{thm}[Global Hamiltonian descent divergence and matched-conventions]\label{thm:divergence-global-ham}
  ...
  \begin{enumerate}[label=(\roman*)]
    \item \emph{Divergence.}  The local theorem is stated on the
      ...
      of this global structure is supplied by the formal disk.
    \item \emph{Obstruction class.}  The acceptance obstruction is
