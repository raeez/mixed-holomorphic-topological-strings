...
\]
the local theorem computes the final arrow on a single formal
Darboux normal slice at a brane stack:
\[
...
Appendix~\ref{app:master-deformation-complex}; cross-volume agreement
