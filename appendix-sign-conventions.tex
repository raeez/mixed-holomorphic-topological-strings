...
The CE/PV comparison, the primitive one-\(\psi\) complex, the
principal-part coadjoint action, and the Moyal deformation use the
following signs.  The cohomological shift convention is
\[
  (V[1])^n=V^{n+1}.
\]
