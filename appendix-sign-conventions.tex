...
Definition~\ref{def:app-sign-hamiltonian-cyclic}, the Hochschild
trace is its image under the Connes \(B\)-operator, and the
negative-cyclic class is the constellation-level Calabi--Yau pairing
of Vol III.  The BCOV holomorphic-anomaly equation enters only as a
...
divergence row of Theorem~\ref{thm:divergence-bcov}; no derivation of
the holomorphic-anomaly equation is asserted by the local Hamiltonian
theorem.
