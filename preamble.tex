%% Legacy preamble file. Not loaded by main.tex; the active preamble
%% lives in mathmacros.tex (which inlines the bound manuscript macros)
%% and in raeez-math-template.sty (loaded via the document class).
%% Kept here as a convention archive.
...
%% closure fragments.
\providecommand{\alpharef}[1]{\ref{#1}}
