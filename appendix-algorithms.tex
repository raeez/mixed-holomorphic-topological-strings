...
from a closed-form coadjoint formula, the Moyal/radial verification
...
\subsection*{Algorithm 5 (Quantization verification at bidegree \((a,b)\))}\label{algo:quantization}
...
\item Compute the SHA-256 hash of the verification JSON for
