...
\subsection*{Algorithm 1 (Build the local trace substitution \(J\))}\label{algo:local-model}
...
\end{enumerate}
\item[Output.]  The trace substitution
...
where \(\Theta_i\) is the Algorithm~1 trace-substitution datum on
...
together with the curvature class blocking the target.
\end{description}
