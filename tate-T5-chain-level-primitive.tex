...
centre even when the cross-volume part of \(\mathfrak o_{\mathrm{cv}}\)
vanishes.
...
\begin{cor}[Primitive indecomposable shadow of the reduced cotangent comparison]
  ...
  \end{align*}
  The unreduced cotangent factorization-center morphism remains
  outside the scope of this composite: its missing data are the
