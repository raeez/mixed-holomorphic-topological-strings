...
\(C^\bullet_{\mathrm{ch}}(A_b,A_b)\) at the \(F_1/F_0\) layer of the
...
\(C^\bullet_{\mathrm{ch}}(A_b,A_b)\) at \(F_1/F_0\).
...
\begin{proof}
  ...
  \(1200\) of \(1225\) nonzero explicit cases disagree under the naive label
